...
Since the image didn't immediately reveal anything, I started by checking its metadata—a common first step in forensics challenges. I used exiftool, which is essential for inspecting the hidden data embedded within files.
